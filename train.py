...
train_dataset = SaliconDataset(split=SPLIT_TRAIN, data_dir=DATA_DIR, img_size=IMG_SIZE)
val_dataset = SaliconDataset(split=SPLIT_VAL, data_dir=DATA_DIR, img_size=IMG_SIZE)
